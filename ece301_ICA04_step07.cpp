...
int main()
{
	...
	else if (divC == "Wheatstone") //Wheatstone circuit
	{
		...
		while (true)
		{
			...
			else if (cond1 < -10e-13 || cond1 > 10e-13)
			{
				break;
			}
			else if (cond2 < -10e-13 || cond2 > 10e-13)
			{
				break;
			}
			else
		...
		inWheat << "Source current: Is = " << setprecision(1) << Is << " Amperes." << endl;
		 ...
		 *       V1 = eV2 + fV3
		 */ 
		double a = (1 + (R4 / R2)), b = (Vs - (Is * R4)), c = (1 + (R5 / R3)), d = (Vs + (Is * R5)), e = (R1 / R2), f = (R1 / R3);
